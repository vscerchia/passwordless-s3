...
util.inherits(S3Store, TokenStore);
 ...
 */
S3Store.prototype.authenticate = function (token, uid, callback) {
 ...
 */
S3Store.prototype.storeOrUpdate = function (token, uid, msToLive, originUrl, callback) {
 ...
 */
S3Store.prototype.invalidateUser = function (uid, callback) {
    if (!uid || !callback) {
...
S3Store.prototype._createHash = function (token) {
